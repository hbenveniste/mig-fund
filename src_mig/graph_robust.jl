...
run(m_ssp1_nofert; ntimesteps = 2100-1950+1)
run(m_ssp2_nofert; ntimesteps = 2100-1950+1)
run(m_ssp3_nofert; ntimesteps = 2100-1950+1)
run(m_ssp4_nofert; ntimesteps = 2100-1950+1)
run(m_ssp5_nofert; ntimesteps = 2100-1950+1)
...
run(m_ssp1_nofert_cb; ntimesteps = 2100-1950+1)
run(m_ssp2_nofert_cb; ntimesteps = 2100-1950+1)
run(m_ssp3_nofert_cb; ntimesteps = 2100-1950+1)
run(m_ssp4_nofert_cb; ntimesteps = 2100-1950+1)
run(m_ssp5_nofert_cb; ntimesteps = 2100-1950+1)
...
run(m_ssp1_nofert_ob; ntimesteps = 2100-1950+1)
run(m_ssp2_nofert_ob; ntimesteps = 2100-1950+1)
run(m_ssp3_nofert_ob; ntimesteps = 2100-1950+1)
run(m_ssp4_nofert_ob; ntimesteps = 2100-1950+1)
run(m_ssp5_nofert_ob; ntimesteps = 2100-1950+1)
...
run(m_ssp1_nofert_2w; ntimesteps = 2100-1950+1)
run(m_ssp2_nofert_2w; ntimesteps = 2100-1950+1)
run(m_ssp3_nofert_2w; ntimesteps = 2100-1950+1)
run(m_ssp4_nofert_2w; ntimesteps = 2100-1950+1)
run(m_ssp5_nofert_2w; ntimesteps = 2100-1950+1)
...
update_param!(m_ssp1_1p, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp2_1p, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp3_1p, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp4_1p, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp5_1p, :gravres, param_mig[:gravres_1p_update])
run(m_ssp1_1p; ntimesteps = 2100-1950+1)
run(m_ssp2_1p; ntimesteps = 2100-1950+1)
run(m_ssp3_1p; ntimesteps = 2100-1950+1)
run(m_ssp4_1p; ntimesteps = 2100-1950+1)
run(m_ssp5_1p; ntimesteps = 2100-1950+1)
...
update_param!(m_ssp1_1p_cb, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp2_1p_cb, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp3_1p_cb, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp4_1p_cb, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp5_1p_cb, :gravres, param_mig[:gravres_1p_update])
run(m_ssp1_1p_cb; ntimesteps = 2100-1950+1)
run(m_ssp2_1p_cb; ntimesteps = 2100-1950+1)
run(m_ssp3_1p_cb; ntimesteps = 2100-1950+1)
run(m_ssp4_1p_cb; ntimesteps = 2100-1950+1)
run(m_ssp5_1p_cb; ntimesteps = 2100-1950+1)
...
update_param!(m_ssp1_1p_ob, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp2_1p_ob, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp3_1p_ob, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp4_1p_ob, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp5_1p_ob, :gravres, param_mig[:gravres_1p_update])
run(m_ssp1_1p_ob; ntimesteps = 2100-1950+1)
run(m_ssp2_1p_ob; ntimesteps = 2100-1950+1)
run(m_ssp3_1p_ob; ntimesteps = 2100-1950+1)
run(m_ssp4_1p_ob; ntimesteps = 2100-1950+1)
run(m_ssp5_1p_ob; ntimesteps = 2100-1950+1)
...
update_param!(m_ssp1_1p_2w, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp2_1p_2w, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp3_1p_2w, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp4_1p_2w, :gravres, param_mig[:gravres_1p_update])
update_param!(m_ssp5_1p_2w, :gravres, param_mig[:gravres_1p_update])
run(m_ssp1_1p_2w; ntimesteps = 2100-1950+1)
run(m_ssp2_1p_2w; ntimesteps = 2100-1950+1)
run(m_ssp3_1p_2w; ntimesteps = 2100-1950+1)
run(m_ssp4_1p_2w; ntimesteps = 2100-1950+1)
run(m_ssp5_1p_2w; ntimesteps = 2100-1950+1)
...
run(m_ssp1_norem; ntimesteps = 2100-1950+1)
run(m_ssp2_norem; ntimesteps = 2100-1950+1)
run(m_ssp3_norem; ntimesteps = 2100-1950+1)
run(m_ssp4_norem; ntimesteps = 2100-1950+1)
run(m_ssp5_norem; ntimesteps = 2100-1950+1)
...
run(m_ssp1_norem_cb; ntimesteps = 2100-1950+1)
run(m_ssp2_norem_cb; ntimesteps = 2100-1950+1)
run(m_ssp3_norem_cb; ntimesteps = 2100-1950+1)
run(m_ssp4_norem_cb; ntimesteps = 2100-1950+1)
run(m_ssp5_norem_cb; ntimesteps = 2100-1950+1)
...
run(m_ssp1_norem_ob; ntimesteps = 2100-1950+1)
run(m_ssp2_norem_ob; ntimesteps = 2100-1950+1)
run(m_ssp3_norem_ob; ntimesteps = 2100-1950+1)
run(m_ssp4_norem_ob; ntimesteps = 2100-1950+1)
run(m_ssp5_norem_ob; ntimesteps = 2100-1950+1)
...
run(m_ssp1_norem_2w; ntimesteps = 2100-1950+1)
run(m_ssp2_norem_2w; ntimesteps = 2100-1950+1)
run(m_ssp3_norem_2w; ntimesteps = 2100-1950+1)
run(m_ssp4_norem_2w; ntimesteps = 2100-1950+1)
run(m_ssp5_norem_2w; ntimesteps = 2100-1950+1)
