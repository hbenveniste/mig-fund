...
@defcomp mig_socioeconomic begin
    ...
    transfer            = Parameter(index=[time,regions])
    ...
    function run_timestep(p,v,d,t)
        ...
        if is_first(t)
            ...
            # Calculate income
            for r in d.regions
                oldincome = v.income[t - 1, r] - (t >= TimestepValue(1990) && !p.runwithoutdamage ? p.consleak * p.eloss[t-1, r] / 10.0 : 0) - (t >= TimestepValue(2015) ? p.transfer[t - 2, r] : 0.0)
